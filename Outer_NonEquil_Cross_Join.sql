...
select a.customer_id, a.contact_name, b.order_id
from customers a
...
from hr.dept a
	left outer join hr.emp b on a.deptno = b.deptno;
...
select a.contact_name, coalesce(b.order_id, 0) order_id, b.order_date, c.first_name||' '||c.last_name employee_name, d.company_name
from customers a
	left outer join orders b on a.customer_id = b.customer_id
	left outer join employees c on b.employee_id = c.employee_id
	left outer join shippers d on b.ship_via = d.shipper_id
where a.city = 'Madrid'
order by 2;
